...
try {
    ...
    if ($current_user) {
        ...
        $notifications = $notificationManager->getUserNotifications($current_user['id'], true, 10);
    ...
    // Silent fail for notification widget
    $notifications = [];
    $unreadCount = 0;
...
<div class="dropdown">
    <button class="btn btn-link text-decoration-none" type="button" id="notificationDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
