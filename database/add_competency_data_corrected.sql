-- Add E-Commerce Competency Data (Corrected)
...
INSERT INTO evaluation_cycles (name, type, start_date, end_date, status, created_by) VALUES
('Q4 2024 E-Commerce Assessment', 'quarterly', '2024-10-01', '2024-12-31', 'active', 1),
('Annual 2024 Competency Review', 'annual', '2024-01-01', '2024-12-31', 'active', 1),
('E-Commerce Skills Evaluation', 'project_based', '2024-11-01', '2024-11-30', 'active', 1);

-- Insert Sample Evaluations
INSERT INTO evaluations (cycle_id, employee_id, evaluator_id, model_id, status, overall_score, completed_at) VALUES
(1, 4, 5, 1, 'completed', 3.80, '2024-11-15 10:30:00'), -- John Doe - E-Commerce Fundamentals
(1, 4, 5, 2, 'completed', 3.00, '2024-11-15 11:00:00'), -- John Doe - Digital Marketing
(1, 5, 1, 1, 'completed', 4.20, '2024-11-16 09:00:00'), -- Jane Smith - E-Commerce Fundamentals
(1, 6, 1, 3, 'completed', 4.25, '2024-11-16 14:00:00'), -- Admin Test - Technical Skills
(2, 4, 5, 4, 'in_progress', NULL, NULL), -- John Doe - Customer Experience (in progress)
(2, 5, 1, 2, 'pending', NULL, NULL); -- Jane Smith - Digital Marketing (pending)

-- Insert sample competency scores for existing evaluations
INSERT INTO competency_scores (evaluation_id, competency_id, score, comments) VALUES

-- John Doe (Employee) - E-Commerce Fundamentals (Evaluation ID 1)
...
-- John Doe - Digital Marketing Excellence (Evaluation ID 2)
(2, 6, 3.00, 'Basic SEO knowledge, needs advanced training'),
(2, 7, 2.50, 'Limited social media marketing experience'),
(2, 8, 3.50, 'Good email marketing skills'),
(2, 9, 2.00, 'Needs CRO training'),
(2, 10, 3.00, 'Basic digital advertising knowledge'),
(2, 11, 3.50, 'Good analytics understanding'),

-- Jane Smith (HR Manager) - E-Commerce Fundamentals (Evaluation ID 3)
(3, 1, 4.50, 'Excellent understanding of e-commerce business'),
(3, 2, 4.00, 'Good digital customer service skills'),
(3, 3, 4.00, 'Proficient in platform navigation'),
(3, 4, 4.50, 'Excellent online communication'),
(3, 5, 4.00, 'Good digital literacy'),

-- Admin Test - E-Commerce Technical Skills (Evaluation ID 4)
(4, 12, 4.50, 'Advanced Shopify development skills'),
(4, 13, 4.00, 'Good WooCommerce management'),
(4, 14, 4.50, 'Expert in payment gateway integration'),
(4, 15, 4.00, 'Good mobile commerce development'),
(4, 16, 4.50, 'Excellent e-commerce security knowledge'),
(4, 17, 4.00, 'Good performance optimization skills');
